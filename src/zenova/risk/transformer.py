"""PyTorch Transformer sequence classifier for crisis risk detection."""
import math
...
class RiskTransformerModel(nn.Module):
    """Transformer sequence classifier for multi-tier crisis and suicide risk detection."""
    ...
    def forward(
        ...
        # Masked average pooling across non-padded tokens
